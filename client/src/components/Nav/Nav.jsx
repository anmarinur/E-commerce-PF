    ...
    return(
        <nav className="navbar d-inline">
                ...
                <div className="row mx-0 py-0 align-items-center justify-content-center" style={{backgroundColor: "#4b1b1b"}}>   
                    ...
                    <form className="d-flex col-4 my-5" role="search">
                        <input className="form-control me-0 rounded-end rounded-pill bg-light"  type="search" placeholder="Buscar" aria-label="Search"/>
                        <button className="btn  text-white rounded-start rounded-pill border-0 px-5 btn-danger"  type="submit">Buscar</button>
                    </form>
