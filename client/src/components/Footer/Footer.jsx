        ...
        <div className="container-fluid" style={{ backgroundColor: "#a52323"}}>
            <footer className="py-3 my-4">
                <ul className="nav justify-content-center pb-3 mb-3">
                    <li className="nav-item "><a href="https://e-commerce-pf-henna.vercel.app/" className="nav-link px-2 text-white">Home</a></li>
                    ...
                    <li className="nav-item "><a href="https://e-commerce-pf-henna.vercel.app/about" className="nav-link px-2 text-white">About</a></li> {/*HREF HARDCODEADO!!! */}
                </ul>
